...
const rules: RateLimitRule[] = [
  ...
  // OAuth (Google) — completar cadastro após primeiro login social
  { key: "auth:complete-profile", limit: 10, windowMs: 3_600_000, methods: ["POST"], byUser: true },
  ...
  { key: "upload:audio",     limit: 20,  windowMs: 60_000,  methods: ["POST"],   byUser: true  },
