...
function setupEventListeners() {
  ...
  // Mapa — busca de serviços
  let mapaBuscaTimeout = null;
  document.getElementById('mapa-busca')?.addEventListener('input', (e) => {
